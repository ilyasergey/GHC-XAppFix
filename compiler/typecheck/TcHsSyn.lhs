...
zonkExpr env (HsAlet binds expr ev_var aletIdsMap aletTooling) = -- panic "appfix: zonkExpr not implemented"
  do (new_env, new_binds) <- zonkLocalBinds env binds	
     new_expr <- zonkLExpr new_env expr
     return (HsAlet new_binds new_expr ev_var aletIdsMap aletTooling)
